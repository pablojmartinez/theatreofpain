...
--[[Pablo J. Martínez function GM:PlayerSpawnSWEP(client, weapon, info)
...
--[[Pablo J. Martínez function GM:PlayerDeathThink(client)
	if (client:getChar()) then
...
function GM:InitPostEntity()
	...
	timer.Simple(5, function() -- Before 0.1 (Pablo J. Martínez)
		hook.Run("LoadData")
	end)
end
