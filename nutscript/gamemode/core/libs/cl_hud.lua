...
function nut.hud.drawDeath()
	...
	local tx, ty = nut.util.drawText("Your sins have not been forgiven, you shall suffer again", w/2, h/2, ColorAlpha(color_white, aprg2 * 255), 1, 1, "nutDynFontMedium", aprg2 * 255) -- L"youreDead"
end
